...
//                $final_amount = $final_amount + 150000;
            ...
            elseif($this->gateway && $this->gateway->key == 'saman'){
                $accounting_app->DoNewSanadVKHBank($transaction_id,0,$final_amount,"کوتاه مدت ملی",1,"Saman");
            }else{
                $accounting_app->DoNewSanadVKHBank($transaction_id,0,$final_amount,"کوتاه مدت ملی",1,"Hozoori");
            }
        } else {
