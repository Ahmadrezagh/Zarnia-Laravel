...
@section('content')
    ...
    <x-page>
        ...
        <x-dataTable
            :url="route('table.products_without_category')"
            id="products-table"
            hasCheckbox="true"
...
<div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="comprehensive-product-meta-title">عنوان متا (Meta Title)</label>
                        <input type="text" class="form-control" id="comprehensive-product-meta-title" name="meta_title">
                    </div>
                    <div class="form-group">
                        <label for="comprehensive-product-meta-description">توضیحات متا (Meta Description)</label>
                        <textarea class="form-control no_ck_editor" id="comprehensive-product-meta-description" name="meta_description" rows="3" placeholder="Meta description..."></textarea>
                    </div>
                    <div class="form-group">
                        <label for="comprehensive-product-meta-keywords">کلمات کلیدی متا (Meta Keywords)</label>
                        <textarea class="form-control no_ck_editor" id="comprehensive-product-meta-keywords" name="meta_keywords" rows="2" placeholder="keyword1, keyword2, keyword3"></textarea>
                    </div>
<div class="form-group">
                        <label for="product-description">توضیحات</label>
